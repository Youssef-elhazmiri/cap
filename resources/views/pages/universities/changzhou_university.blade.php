...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/CZU_Accommodations.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/CZU_campus.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/CZU_accommodation_amenities.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Changzhou University (CZU) Logo"  class="logo lazyloaded" decoding="async" nitro-lazy-empty="images/univ_logo/changzhou_university.jpg" id="ODI1MzoxNTQ=-1" src="images/univ_logo/changzhou_university.jpg"> </div>
    </div>
    <div class="mr-md-2  row main position-relative justify-content-between  mb-md-5">
                    ...
                    <div class="col-sm">
                        <article id="introduction" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                ...
                                <p></p>
                                <p>Changzhou University (CZU) is a public university in Changzhou, the capital of Jiangsu Province, China. It is a comprehensive university with an excellence in teacher training and professional development.</p>
                                <p>CZU has nearly 20,000 full-time students, 18,400 of whom are undergraduates. There are 214 professors working at the university.</p>
                                <p></p>
                            </section>
                        </article>
                    </div>
                    ...
                    <div class="col-sm">
                        <article id="accommodation" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                ...
                                <nav id="campus-nav">
                                    <div class="nav" id="nav-tab" role="tablist"> <a class="nav-item nav-link   active  " id="nav-international-dormitory-tab" data-toggle="tab" href="#nav-international-dormitory" role="tab" aria-controls="nav-international-dormitory" aria-selected="true">International Dormitory </a> </div>
                                </nav>
                                    ...
                                    <div class="tab-pane fade   active show  " id="nav-international-dormitory" role="tabpanel" aria-labelledby="nav-international-dormitory-tab">
                                        ...
                                        <table class="table table-bordered table-striped mt-4 table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>DOUBLE</td>
                                                    <td> <span class="money">12,606 MAD</span></td>
                                                    <td>RMB 9000/year, double room in the international dormitory</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="question-box d-none ">
                                        ...
                                        <div class="p-3" style="background:#e5e5e5;">
                                            <form id="program-question">
                                                ...
                                                <div class="col-md-6"><button class="ca-button w-auto" type="submit">Ask Question</button></div> <input type="hidden" name="school" value="114">
                                            </form>
                                        </div>
                                    </div>
                                    <ul class="questions-answers-container list">
                                        <li class="d-flex mt-3 mb-3">
                                            <div class="votes d-flex flex-column align-items-center flex-shrink-0" style="border-right: 1px solid #ddd;text-align: center;color: #000;padding: 0;margin: 0;width: 65px;">
                                                <div class="upvote">
                                                    <i class="fa-2x fas fa-caret-up" onclick="vote(159,'up')"></i>
                                                </div>
                                                <div class="align-items-center d-flex flex-column vote-count">
                                                    <span class="count" id="count-159">0</span>
                                                    <span>votes</span>
                                                </div>
                                                <div class="downvote">
                                                    <i class="fa-2x fas fa-caret-down" onclick="vote(159,'down')"></i>
                                                </div>
                                            ...
                                            <div class="question-answers p-2">
                                                <div class="questions d-flex mb-4">
                                                    ...
                                                    <strong class="userQuestion hide-class"> Does CZU give fully funded scholarship to undergraduate international students?</strong>
                                                </div>
                                                <div class="answer d-flex">
                                                    ...
                                                    <div class="d-flex flex-column flex-shrink-1">
                                                        ...
                                                        <strong class="reply">Hello Laiba,<div><br></div>
                                                            <div>
                                                                <div>
                                                        ...
                                                        <span class="author">by Saskia - China Admissions on January 31, 2022</span>
                ...
                <div class="row">
                    <div class="col-sm">
                        <article id="admissions-reviews" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                <h3 class="ca-card-title mt-5">📝 Changzhou University (CZU) Reviews</h3>
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="city-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-857 {
                                                                    fill: url(#857_SVGID_1_);
                                                                }

                                                                .svg-hovered-857 {
                                                                    fill: url(#857_SVGID_2_);
                                                                }

                                                                .svg-active-857 {
                                                                    fill: url(#857_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="857_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="857_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="857_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-857" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-857" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-857" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-857 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="accommodation-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-80 {
                                                                    fill: url(#80_SVGID_1_);
                                                                }

                                                                .svg-hovered-80 {
                                                                    fill: url(#80_SVGID_2_);
                                                                }

                                                                .svg-active-80 {
                                                                    fill: url(#80_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="80_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="80_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="80_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-80" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-80" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-80" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-80 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="food-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-788 {
                                                                    fill: url(#788_SVGID_1_);
                                                                }

                                                                .svg-hovered-788 {
                                                                    fill: url(#788_SVGID_2_);
                                                                }

                                                                .svg-active-788 {
                                                                    fill: url(#788_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="788_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="788_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="788_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-788" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-788" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-788" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-788 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="facilities-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-64 {
                                                                    fill: url(#64_SVGID_1_);
                                                                }

                                                                .svg-hovered-64 {
                                                                    fill: url(#64_SVGID_2_);
                                                                }

                                                                .svg-active-64 {
                                                                    fill: url(#64_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="64_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="64_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="64_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-64" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-64" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-64" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-64 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="money-for-value-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-261 {
                                                                    fill: url(#261_SVGID_1_);
                                                                }

                                                                .svg-hovered-261 {
                                                                    fill: url(#261_SVGID_2_);
                                                                }

                                                                .svg-active-261 {
                                                                    fill: url(#261_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="261_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="261_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="261_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-261" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-261" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-261" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-261 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="classes-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-76 {
                                                                    fill: url(#76_SVGID_1_);
                                                                }

                                                                .svg-hovered-76 {
                                                                    fill: url(#76_SVGID_2_);
                                                                }

                                                                .svg-active-76 {
                                                                    fill: url(#76_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="76_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="76_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="76_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-76" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-76" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-76" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-76 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="student-experience-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-327 {
                                                                    fill: url(#327_SVGID_1_);
                                                                }

                                                                .svg-hovered-327 {
                                                                    fill: url(#327_SVGID_2_);
                                                                }

                                                                .svg-active-327 {
                                                                    fill: url(#327_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="327_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="327_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="327_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-327" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-327" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-327" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-327 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="recommendation-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-531 {
                                                                    fill: url(#531_SVGID_1_);
                                                                }

                                                                .svg-hovered-531 {
                                                                    fill: url(#531_SVGID_2_);
                                                                }

                                                                .svg-active-531 {
                                                                    fill: url(#531_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="531_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="531_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="531_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-531" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-531" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-531" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-531 {
            ...
            <div class="col p-0">
                <article id="admissions-related-programs" style="margin-bottom:0;">
                    <section class="mdc-card__supporting-text p-0 p-md-3">
                        <h3 class="ca-card-title mt-5">Other Universities in Changzhou</h3>
                        <section class="d-lg-flex ">
                            <div class="col-md-4 col-12 p-0">
                                <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0">
                                    <div class="card-body d-flex pl-2 pr-2 pb-2">
                                        <div class="p-0 col-lg-3"> <img style="width:60px;height:60px;background:#fff;padding:5px;" alt="Changzhou College of Information Technology (CCIT) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Changzhou_College_of_Information_Technology_(CCIT).png" class="nitro-lazy" decoding="async" nitro-lazy-empty="" id="OTU2NjoyMzM=-1" src="data:image/svg+xml;nitro-empty-id=OTU2NjoyMzM=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjAwIDIwMCIgd2lkdGg9IjIwMCIgaGVpZ2h0PSIyMDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+"> </div>
                                        <div class="p-0 col-9">
                                            <div class="d-flex justify-content-between">
                                                <div class="justify-content-start w-100 col-7 p-0">
                                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100"> Changzhou College of Information Technology (CCIT) </h3>
                                                </div>
                                                <div class="col-5 p-0 d-flex align-items-center "> </div>
                                            </div>
                                        </div> <a href="/university/changzhou-college-of-information-technology/" class="stretched-link"> </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-12 p-0">
                                <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0">
                                    <div class="card-body d-flex pl-2 pr-2 pb-2">
                                        <div class="p-0 col-lg-3"> <img style="width:60px;height:60px;background:#fff;padding:5px;" alt="Changzhou Institute of Technology (CIT) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Changzhou_Institute_of_Technology_(CIT).png" class="nitro-lazy" decoding="async" nitro-lazy-empty="" id="OTYwMjoyMTE=-1" src="data:image/svg+xml;nitro-empty-id=OTYwMjoyMTE=-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjAwIDIwMCIgd2lkdGg9IjIwMCIgaGVpZ2h0PSIyMDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+"> </div>
                                        <div class="p-0 col-9">
                                            <div class="d-flex justify-content-between">
                                                <div class="justify-content-start w-100 col-7 p-0">
                                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100"> Changzhou Institute of Technology (CIT) </h3>
                                                </div>
                                                <div class="col-5 p-0 d-flex align-items-center "> </div>
                                            </div>
                                        </div> <a href="/university/changzhou-institute-of-technology/" class="stretched-link"> </a>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <div class="see-more mt-2"> <strong> <a style="color:#d71f27;" href="/universities/?city=Changzhou">See more universities in Changzhou</a> </strong> </div>
                    </section>
                </article>
            </div>
        </div>
        <div class="col-12 pl-lg-0 pr-lg-0 wordpress-posts mb-4">
            <div class="col p-0">
                <article style="margin-bottom:0;">
                    <section class="mdc-card__supporting-text p-0 p-md-3">
                        <h3 class="ca-card-title blog-title-about d-none">Blog Posts About Changzhou University (CZU)</h3>
    ...
    <script src="blob:https://apply.china-admissions.com/b3bbd1ac-f84b-4102-ab5d-57a156370ba6" data-nitro-for-id="2e8cb65a563e3cc5eb991ab427dd437e-1" id="2e8cb65a563e3cc5eb991ab427dd437e-1"></script>
</div>
