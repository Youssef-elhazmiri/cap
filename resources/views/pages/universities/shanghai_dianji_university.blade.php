@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Shanghai Dianji University (SDJU)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/Shanghai_Dianji_University_(SDJU)_1.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Shanghai_Dianji_University_(SDJU)_3.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Shanghai_Dianji_University_(SDJU)_6.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Shanghai Dianji University (SDJU) Logo" nitro-lazy-src="images/univ_logo/shanghai_dianji_university.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI2OToxNzU=-1" src="images/univ_logo/shanghai_dianji_university.jpg"> </div>
    </div>
