@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Shanghai University of Engineering Science (SUES)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/Shanghai_University_of_Engineering_Science_(SUES)_9.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Shanghai_University_of_Engineering_Science_(SUES)_3.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Shanghai_University_of_Engineering_Science_(SUES)_4.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Shanghai University of Engineering Science (SUES) Logo" nitro-lazy-src="images/univ_logo/shanghai_university_of_engineering_science.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODMxNDoyMTQ=-1" src="images/univ_logo/shanghai_university_of_engineering_science.jpg"> </div>
    </div>
