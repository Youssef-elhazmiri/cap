@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Jiangsu University of Science and Technology (JUST)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/JUST5.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/JUST2.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/JUST4.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Jiangsu University of Science and Technology (JUST) Logo" nitro-lazy-src="images/univ_logo/jiangsu_university_science_and_technology.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODMwNToxODE=-1" src="images/univ_logo/jiangsu_university_science_and_technology.jpg"> </div>
    </div>
