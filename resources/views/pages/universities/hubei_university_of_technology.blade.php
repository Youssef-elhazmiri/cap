@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Hubei University of Technology (HBUT)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/Hubei_University_of_Technology_(HBUT)_1.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Hubei_University_of_Technology_(HBUT)_7.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Hubei_University_of_Technology_(HBUT)_6.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Hubei University of Technology (HBUT) Logo" nitro-lazy-src="images/univ_logo/hubei_university_of_technology.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI5NjoxOTA=-1" src="images/univ_logo/beijing_foreign_studies_univ.jpg"> </div>
    </div>
