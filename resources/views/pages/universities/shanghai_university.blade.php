@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Shanghai University (SHU)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/SHU-Campus.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/SHU-Campus2.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/SHU-Stairwell.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Shanghai University (SHU) Logo" nitro-lazy-src="images/univ_logo/shanghai_university.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI0MjoxNDg=-1" src="images/univ_logo/shanghai_university.jpg"> </div>
    </div>
