...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Jiangsu Normal University (JSNU) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/180px-Jiangsu_Normal_University_logo.png" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI2OToxODQ=-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/180px-Jiangsu_Normal_University_logo.png"> </div>
    </div>
    <div class="mr-md-2  row main position-relative justify-content-between  mb-md-5">
        ...
        <div class="footer d-md-none position-sticky w-100" style="bottom:0px;z-index:2;background:#fff;">
            <article style="margin-bottom:0;">
                <section class="card-body"> <a style="text-decoration:none;" href="#admissions-programs" class="ca-button w-100 btn btn-danger"> See Programs </a> <small class="d-flex justify-content-center mt-2"> 81 students applied to this university</small> </section>
            </article>
        </div>
