...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Yunnan University (YNU) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/51YunNan_University_logo.svg_.png" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODIyNDoxNjg=-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/51YunNan_University_logo.svg_.png"> </div>
    </div>
    <div class="mr-md-2  row main position-relative justify-content-between  mb-md-5">
            ...
            <div class="mb-4">
                ...
                <div class="d-flex" style="overflow-x:auto;">
                    <div class="uni-stats d-flex flex-column">
                        <h3>30219</h3><small>Total Students</small>
                    </div>
                    <div class="uni-stats d-flex flex-column">
                        <h3 class="badge badge-success">211 University</h3>
                    </div>
                    <div class="uni-stats d-flex flex-column">
                        <h3>1922</h3><small>Founded</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm">
                        <article id="introduction" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                ...
                                <p></p>
                                <p>Apply online now at Yunnan University, Kunming, China for 2022 intake. Info of admissions for international students, scholarships, and more.</p>
                                <p></p>
                            </section>
                        </article>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm">
                        <article id="about-school" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                <h3 class="ca-card-title mt-5">🏫 About Yunnan University (YNU)</h3>
                                <div id="about-school-short"> Yunnan University was founded in 1922. It is one of the earliest comprehensive universities in Southwest China. Yunnan University offers a good academic atmosphere and a well-established ideological foundation in the fields of the humanities and social sciences thanks to its close to century-long tradition and its academic heritage. Yunnan University has joined itself to the national developmental strategy and that of Yunnan province by promoting teaching through scientific research. In recent years, it has undertaken and successfully completed many major scientific research projects. YNU has gained a worldwide reputation through the discovery and research of the Maotianshan Shales (especially the Chengjiang biota) in early Cambrian leader by professor Hou Xianguang, who was rewarded the first class of State Natural Science Award in 2003. </div>
                            </section>
                        </article>
                    </div>
                </div>
                    ...
                    <div class="col-sm">
                        <article id="admissions-programs" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                ...
                                <p> <a style="text-decoration:none;" href="/search/?utm_source=YNU&amp;utm_campaign=No_programs" class="ca-button btn btn-danger mb-4"> Show similar programs </a> </p>
                            ...
                            <section class="mdc-card__supporting-text">
                                ...
                                <section id="Steps" class="steps-section mb-4 mt-2">
                                    ...
                                    <div class="steps-timeline" id="steps-timeline">
                                        <div class="steps-one"> <img alt="Application step 1" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/apply.china-admissions.com/static/assets/icon/step1.png" class="steps-img lazyloaded" decoding="async" nitro-lazy-empty="" id="ODQ0Mjo3NA==-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/apply.china-admissions.com/static/assets/icon/step1.png">
                                        ...
                                        <div class="steps-two"> <img alt="Application step 2" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/apply.china-admissions.com/static/assets/icon/step2.png" class="steps-img lazyloaded" decoding="async" nitro-lazy-empty="" id="ODQ1Njo3NA==-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/apply.china-admissions.com/static/assets/icon/step2.png">
                                        ...
                                        <div class="steps-three"> <img alt="Application step 3" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/apply.china-admissions.com/static/assets/icon/step3.png" class="steps-img lazyloaded" decoding="async" nitro-lazy-empty="" id="ODQ3MDo3NA==-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/apply.china-admissions.com/static/assets/icon/step3.png">
                                    ...
                                    <div class="question-box d-none ">
                                        ...
                                        <div class="p-3" style="background:#e5e5e5;">
                                            <form id="program-question">
                                                ...
                                                <div class="col-md-6"><button class="ca-button w-auto" type="submit">Ask Question</button></div> <input type="hidden" name="school" value="285">
                                            </form>
                                        </div>
                                    </div>
                                    <ul class="questions-answers-container list">
                                        <li class="d-flex mt-3 mb-3">
                                            <div class="votes d-flex flex-column align-items-center flex-shrink-0" style="border-right: 1px solid #ddd;text-align: center;color: #000;padding: 0;margin: 0;width: 65px;">
                                                <div class="upvote">
                                                    <i class="fa-2x fas fa-caret-up" onclick="vote(612,'up')"></i>
                                                </div>
                                                <div class="align-items-center d-flex flex-column vote-count">
                                                    <span class="count" id="count-612">0</span>
                                                    <span>votes</span>
                                                </div>
                                                <div class="downvote">
                                                    <i class="fa-2x fas fa-caret-down" onclick="vote(612,'down')"></i>
                                                </div>
                                            ...
                                            <div class="question-answers p-2">
                                                <div class="questions d-flex mb-4">
                                                    ...
                                                    <strong class="userQuestion hide-class"> how to apply for scholarship?</strong>
                                                </div>
                                                <div class="answer d-flex">
                                                    ...
                                                    <div class="d-flex flex-column flex-shrink-1">
                                                        ...
                                                        <strong class="reply">
                                                            <div>We do not currently process scholarship applications. You will need to find out from the university directly about available scholarships and apply directly.</div>
                                                            <br>
                                                            You can find more information on our blog about scholarships <a href="https://articles.globaladmissions.com/blog/global-scholarship-guide-2022-2023/">here</a>.
                                                        </strong>
                                                        <span class="author">by Saskia - China Admissions on July 20, 2022</span>
                ...
                <div class="row">
                    <div class="col-sm">
                        <article id="admissions-reviews" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                <h3 class="ca-card-title mt-5">📝 Yunnan University (YNU) Reviews</h3>
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="city-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-205 {
                                                                    fill: url(#205_SVGID_1_);
                                                                }

                                                                .svg-hovered-205 {
                                                                    fill: url(#205_SVGID_2_);
                                                                }

                                                                .svg-active-205 {
                                                                    fill: url(#205_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="205_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="205_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="205_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-205" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-205" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-205" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-205 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="accommodation-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-172 {
                                                                    fill: url(#172_SVGID_1_);
                                                                }

                                                                .svg-hovered-172 {
                                                                    fill: url(#172_SVGID_2_);
                                                                }

                                                                .svg-active-172 {
                                                                    fill: url(#172_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="172_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="172_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="172_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-172" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-172" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-172" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-172 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="food-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-180 {
                                                                    fill: url(#180_SVGID_1_);
                                                                }

                                                                .svg-hovered-180 {
                                                                    fill: url(#180_SVGID_2_);
                                                                }

                                                                .svg-active-180 {
                                                                    fill: url(#180_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="180_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="180_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="180_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-180" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-180" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-180" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-180 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="facilities-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-89 {
                                                                    fill: url(#89_SVGID_1_);
                                                                }

                                                                .svg-hovered-89 {
                                                                    fill: url(#89_SVGID_2_);
                                                                }

                                                                .svg-active-89 {
                                                                    fill: url(#89_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="89_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="89_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="89_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-89" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-89" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-89" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-89 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="money-for-value-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-234 {
                                                                    fill: url(#234_SVGID_1_);
                                                                }

                                                                .svg-hovered-234 {
                                                                    fill: url(#234_SVGID_2_);
                                                                }

                                                                .svg-active-234 {
                                                                    fill: url(#234_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="234_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="234_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="234_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-234" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-234" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-234" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-234 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="student-experience-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-768 {
                                                                    fill: url(#768_SVGID_1_);
                                                                }

                                                                .svg-hovered-768 {
                                                                    fill: url(#768_SVGID_2_);
                                                                }

                                                                .svg-active-768 {
                                                                    fill: url(#768_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="768_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="768_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="768_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-768" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-768" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-768" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-768 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="recommendation-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-208 {
                                                                    fill: url(#208_SVGID_1_);
                                                                }

                                                                .svg-hovered-208 {
                                                                    fill: url(#208_SVGID_2_);
                                                                }

                                                                .svg-active-208 {
                                                                    fill: url(#208_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="208_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="208_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="208_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-208" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-208" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-208" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-208 {
            ...
            <div class="col p-0">
                <article id="admissions-related-programs" style="margin-bottom:0;">
                    <section class="mdc-card__supporting-text p-0 p-md-3">
                        <h3 class="ca-card-title mt-5">Other Universities in Kunming</h3>
                        <section class="d-lg-flex ">
                            <div class="col-md-4 col-12 p-0">
                                <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0">
                                    <div class="card-body d-flex pl-2 pr-2 pb-2">
                                        <div class="p-0 col-lg-3"> <img style="width:60px;height:60px;background:#fff;padding:5px;" alt="Kunming Medical University (KMU) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Kunming_Medical_University_Logo.png" class="lazyloaded" decoding="async" nitro-lazy-empty="" id="ODkwMDoxOTY=-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Kunming_Medical_University_Logo.png"> </div>
                                        <div class="p-0 col-9">
                                            <div class="d-flex justify-content-between">
                                                <div class="justify-content-start w-100 col-7 p-0">
                                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100"> Kunming Medical University (KMU) </h3>
                                                </div>
                                                <div class="col-5 p-0 d-flex align-items-center "> </div>
                                            </div>
                                        </div> <a href="/university/kunming-medical-university-kmu/" class="stretched-link"> </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-12 p-0">
                                <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0">
                                    <div class="card-body d-flex pl-2 pr-2 pb-2">
                                        <div class="p-0 col-lg-3"> <img style="width:60px;height:60px;background:#fff;padding:5px;" alt="Kunming University of Science and Technology (KMUST) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Kunming_University_of_Science_and_Technology_(KMUST).png" class="lazyloaded" decoding="async" nitro-lazy-empty="" id="ODkzNjoyMzc=-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Kunming_University_of_Science_and_Technology_(KMUST).png"> </div>
                                        <div class="p-0 col-9">
                                            <div class="d-flex justify-content-between">
                                                <div class="justify-content-start w-100 col-7 p-0">
                                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100"> Kunming University of Science and Technology (KMUST) </h3>
                                                </div>
                                                <div class="col-5 p-0 d-flex align-items-center "> </div>
                                            </div>
                                        </div> <a href="/university/kunming-university-of-science-and-technology/" class="stretched-link"> </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-12 p-0">
                                <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0">
                                    <div class="card-body d-flex pl-2 pr-2 pb-2">
                                        <div class="p-0 col-lg-3"> <img style="width:60px;height:60px;background:#fff;padding:5px;" alt="Yunnan Normal University (YNNU) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Yunnan_Normal_University_(YNNU).png" class="lazyloaded" decoding="async" nitro-lazy-empty="" id="ODk3MjoxOTU=-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Yunnan_Normal_University_(YNNU).png"> </div>
                                        <div class="p-0 col-9">
                                            <div class="d-flex justify-content-between">
                                                <div class="justify-content-start w-100 col-7 p-0">
                                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100"> Yunnan Normal University (YNNU) </h3>
                                                </div>
                                                <div class="col-5 p-0 d-flex align-items-center "> </div>
                                            </div>
                                        </div> <a href="/university/yunnan-normal-university/" class="stretched-link"> </a>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <div class="see-more mt-2"> <strong> <a style="color:#d71f27;" href="/universities/?city=Kunming">See more universities in Kunming</a> </strong> </div>
                    </section>
                </article>
            </div>
        </div>
        <div class="col-12 pl-lg-0 pr-lg-0 wordpress-posts mb-4">
            <div class="col p-0">
                <article style="margin-bottom:0;">
                    <section class="mdc-card__supporting-text p-0 p-md-3">
                        <h3 class="ca-card-title blog-title-about d-none">Blog Posts About Yunnan University (YNU)</h3>
    ...
    <script src="blob:https://apply.china-admissions.com/33a9ad4a-7d04-4430-91e8-754ed4539d37" data-nitro-for-id="2e8cb65a563e3cc5eb991ab427dd437e-1" id="2e8cb65a563e3cc5eb991ab427dd437e-1"></script>
</div>
