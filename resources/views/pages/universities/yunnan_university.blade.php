@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Yunnan University (YNU)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/16958045569851.jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/700b08db69a82de6755211e4662c9332.jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/1509605460941041290.png" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Yunnan University (YNU) Logo" nitro-lazy-src="images/univ_logo/yunnan_university.png" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODIyNDoxNjg=-1" src="images/univ_logo/yunnan_university.png"> </div>
    </div>
