@extends('layouts.app')
@section('content')
@section('title') {{'CAP - South China University of Technology (SCUT)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/SCUT_campus.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/South_China_University_of_Technology_SCUT.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Dorm_room.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="South China University of Technology (SCUT) Logo" nitro-lazy-src="images/univ_logo/south_china.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI1MzoxNjg=-1" src="images/univ_logo/south_china.jpg"> </div>
    </div>
