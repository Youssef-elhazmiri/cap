...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Beijing Foreign Studies University (BFSU) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/04b0af801b0547f09652566619d3bcfa_YHTpzqM.png" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI5ODoxOTc=-1" src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/04b0af801b0547f09652566619d3bcfa_YHTpzqM.png"> </div>
    </div>
    <div class="mr-md-2  row main position-relative justify-content-between  mb-md-5">
            ...
            <div class="mb-4">
                <div class="row">
                    <div class="col-sm d-md-flex flex-sm-column flex-md-row mb-4">
                        <div>
                            <h3>Beijing Foreign Studies University (BFSU)</h3>
                            <h5 style="color:#777;" class="align-items-end d-flex">
                                ...
                                <div class="rating-left program-ratings d-flex align-items-end ml-lg-2 ml-2" style="flex-flow:wrap;"> <a href="#admissions-reviews">
                                        <p class="m-0 lazyloaded"><span class="badge badge-warning " id="overall-score">8.2</span> </p>
                                    </a> <a href="#admissions-reviews" class="ml-1" style="font-size:12px;"> ( <span id="review-count">23 Reviews</span> )</a>
                                    <div></div>
                                </div>
                            </h5>
                        </div>
                    ...
                    <div class="col-sm">
                        <article id="introduction" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                ...
                                <p></p>
                                <p>BFSU is a leading University in Beijing, traditionally specialising in training of Chinese ambassador’s and diplomats, there are now more than 400 ambassador’s or diplomats who have graduated from BFSU.<br>BFSU helps students with internships an career advice. Such as with ShunFeng, HSBC, Deloitte, PWC, Mercedes Benz, JP Morgan Chase etc.</p>
                                <p></p>
                            </section>
                        </article>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm">
                        <article id="about-school" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                <h3 class="ca-card-title mt-5">🏫 About Beijing Foreign Studies University (BFSU)</h3>
                                
                                    <p>Beijing Foreign Studies University, or BFSU, is one of China’s top universities under the direct leadership of the Chinese Ministry of Education. It is listed under Project 985, Project 211 and Double First-Class Project of China. Located in Haidian District, Beijing, it has two campuses- the West Campus and the East Campus, separated by the North Xisanhuan Road.</p>
                                    ...
                                    <p><strong>Europe</strong><br> NUI Maynooth (Ireland)<br> Hanze University, Groningen (Netherland)<br> Universidad Europea de Madrid (Spain)<br> University of Applied Sciences Northwestern (Switzerland)<br> Edinburgh Napier University (UK)<br> Lancaster University (UK)<br> Salford University (UK)<br> University of Kent (UK)</p>
                                    <p><strong>Australia</strong><br> Edith Cowan University (Australia)<br> La Trobe University (Australia)<br> Queensland University of Technology (Australia)<br> The University of Queensland (Australia)<br> The University of Newcastle (Australia)</p>
                                    <p><strong>America</strong><br> Newfoundland Memorial University (Canada)<br> Tecnologico de Monterrey (Mexico)<br> University of Louisville (USA)<br> Virginia Commonwealth University (USA)</p>
                                    <p><strong>Asia</strong><br> Nagoya University of Foreign Studies (Japan)<br> SolBridge International School of Business (Korea)<br> University Tun Abdul Razak (Malaysia)</p>
                    ...
                    <div class="col-sm">
                        <article id="accommodation" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                ...
                                <nav id="campus-nav">
                                    <div class="nav" id="nav-tab" role="tablist"> <a class="nav-item nav-link   active  " id="nav-white-building-tab" data-toggle="tab" href="#nav-white-building" role="tab" aria-controls="nav-white-building" aria-selected="true">White Building </a> <a class="nav-item nav-link  " id="nav-guojiao-building-tab" data-toggle="tab" href="#nav-guojiao-building" role="tab" aria-controls="nav-guojiao-building" aria-selected="true">Guojiao Building </a> <a class="nav-item nav-link  " id="nav-domestic-building-tab" data-toggle="tab" href="#nav-domestic-building" role="tab" aria-controls="nav-domestic-building" aria-selected="true">Domestic Building </a> <a class="nav-item nav-link  " id="nav-no-6-building-tab" data-toggle="tab" href="#nav-no-6-building" role="tab" aria-controls="nav-no-6-building" aria-selected="true">No. 6 Building </a> </div>
                                </nav>
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade   active show  " id="nav-white-building" role="tabpanel" aria-labelledby="nav-white-building-tab">
                                        ...
                                        <div class="d-flex accomodation-images" style="overflow-x:scroll;height:200px;">
                                            ...
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-1.jpg" class="w-30" data-fancybox="white-building-gallery" data-caption="White Building - Double Room">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-1.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-4.jpg" class="w-30" data-fancybox="white-building-gallery" data-caption="White Building - Double Room 2">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-4.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-3.jpg" class="w-30" data-fancybox="white-building-gallery" data-caption="White Building 4">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-3.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-2.jpg" class="w-30" data-fancybox="white-building-gallery" data-caption="White Building - Single Room">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-2.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-5.jpg" class="w-30" data-fancybox="white-building-gallery" data-caption="White Building - Amenities 1">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-5.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/White-Building-6.jpg" class="w-30" data-fancybox="white-building-gallery" data-caption="White Building - Amenities 2">
                                        ...
                                        <table class="table table-bordered table-striped mt-4 table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>SINGLE</td>
                                                    <td> <span class="money">98 MAD</span></td>
                                    ...
                                    <div class="tab-pane fade  " id="nav-guojiao-building" role="tabpanel" aria-labelledby="nav-guojiao-building-tab">
                                        <div class="mt-2 mb-2">📍 Beijing Foreign Studies University (BFSU)/Beijing Campus/ Guojiao Building</div>
                                        <div class="d-flex accomodation-images" style="overflow-x:scroll;height:200px;">
                                            <div class="video"> </div> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building.jpg" class="w-30" data-fancybox="guojiao-building-gallery" data-caption="Guojiao Building">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Single-Room.jpg" class="w-30" data-fancybox="guojiao-building-gallery" data-caption="Guojiao Building - Single Room 1">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Single-Room.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Double-Room.jpg" class="w-30" data-fancybox="guojiao-building-gallery" data-caption="Guojiao Building - Double Room 1">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Double-Room.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Double-Room-2.jpg" class="w-30" data-fancybox="guojiao-building-gallery" data-caption="Guojiao Building - Double Room 2">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Double-Room-2.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Bathroom.jpg" class="w-30" data-fancybox="guojiao-building-gallery" data-caption="Guojiao Building - Bathroom">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Bathroom.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Amenities.jpg" class="w-30" data-fancybox="guojiao-building-gallery" data-caption="Guojiao Building - Amenities">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Guojiao-Building-Amenities.jpg"> </div>
                                            </a>
                                        </div>
                                        <p class="intro-headers">Accomodation Details:</p>
                                        <p></p>
                                        <p>Guojiao Building is located on the east campus of BFSU. Next to it is the Chinese Academy Building and the Student Canteen of the East campus. It is very convenient to go to the library, gymnasium, and gym from the GuojiaoBuilding. It takes about 10-15 minutes to walk from here to the BFSU West Campus.</p>
                                        <p></p>
                                        <table class="table table-bordered table-striped mt-4 table-hover">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>SINGLE</td>
                                                    <td> <span class="money">154 MAD</span></td>
                                                    <td>RMB 110/day/room. Private bathroom.</td>
                                                </tr>
                                                <tr>
                                                    <td>SINGLE</td>
                                                    <td> <span class="money">126 MAD</span></td>
                                    ...
                                    <div class="tab-pane fade  " id="nav-domestic-building" role="tabpanel" aria-labelledby="nav-domestic-building-tab">
                                        <div class="mt-2 mb-2">📍 Beijing Foreign Studies University (BFSU)/Beijing Campus/ Domestic Building</div>
                                        <div class="d-flex accomodation-images" style="overflow-x:scroll;height:200px;">
                                            <div class="video"> </div> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building.jpg" class="w-30" data-fancybox="domestic-building-gallery" data-caption="Domestic Building">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Single-Room1.jpg" class="w-30" data-fancybox="domestic-building-gallery" data-caption="Domestic Building - Single Room">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Single-Room1.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Single-Room2.jpg" class="w-30" data-fancybox="domestic-building-gallery" data-caption="Domestic Building - Single Room 2">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Single-Room2.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Double-Room1.jpg" class="w-30" data-fancybox="domestic-building-gallery" data-caption="Domestic Building - Double Room 1">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Double-Room1.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Double-Room2.jpg" class="w-30" data-fancybox="domestic-building-gallery" data-caption="Domestic Building - Double Room 2">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Domestic-Building-Double-Room2.jpg"> </div>
                                            </a>
                                        </div>
                                        <p class="intro-headers">Accomodation Details:</p>
                                        <p></p>
                                        <p>The Domestic Building dormitory is newly built located in the west campus. Close to West Campus canteen, international building, and office building.</p>
                                        <p></p>
                                        <table class="table table-bordered table-striped mt-4 table-hover">
                                            <thead>
                                                <tr>
                                    ...
                                    <div class="tab-pane fade  " id="nav-no-6-building" role="tabpanel" aria-labelledby="nav-no-6-building-tab">
                                        <div class="mt-2 mb-2">📍 Beijing Foreign Studies University (BFSU)/Beijing Campus/ No. 6 Building</div>
                                        <div class="d-flex accomodation-images" style="overflow-x:scroll;height:200px;">
                                            <div class="video"> </div> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6.jpg" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Double-Room1.jpg" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6 - Double Room">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Double-Room1.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Accommodations.jpg" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6 - Accommodations">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Accommodations.jpg"> </div>
                                            </a> <a href="https://upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Amenities.jpg" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6 - Amenities">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Amenities.jpg"> </div>
                                            </a>
                                        </div>
                                        <p class="intro-headers">Accomodation Details:</p>
                                        <p></p>
                                        <p>Building No. 6 is located next to the Domestic Building and close to the school hospital. Adjacent to the West Campus Canteen, Canteen for International Students. It only takes 3-5 minutes to walk from the White Building and Building 6 to the International Building for classes.</p>
                                        <p></p>
                                        <table class="table table-bordered table-striped mt-4 table-hover">
                                            <thead>
                                                <tr>
                                ...
                                <section class="mb-4 mt-2">
                                    <div class="d-flex mb-2">
                                        <div class="align-items-center col-6 d-flex flex-column"> <i class="fas fa-stopwatch mb-2" style="font-size:2rem;"></i>
                                            <h4>10 Days</h4> <strong> Av. Processing Speed</strong>
                                        </div>
                                    </div>
                                    <p></p>
                                    <p></p>
                                    ...
                                    <div class="question-box d-none ">
                                        ...
                                        <div class="p-3" style="background:#e5e5e5;">
                                            <form id="program-question" class="nitro-lazy">
                                                ...
                                                <div class="col-md-6"><button class="ca-button w-auto" type="submit">Ask Question</button></div> <input type="hidden" name="school" value="80">
                                            </form>
                                        </div>
                                    </div>
                                    <ul class="questions-answers-container list">
                                        <li class="d-flex mt-3 mb-3">
                                            <div class="votes d-flex flex-column align-items-center flex-shrink-0" style="border-right: 1px solid #ddd;text-align: center;color: #000;padding: 0;margin: 0;width: 65px;">
                                                <div class="upvote">
                                                    <i class="fa-2x fas fa-caret-up" onclick="vote(708,'up')"></i>
                                                </div>
                                                <div class="align-items-center d-flex flex-column vote-count">
                                                    <span class="count" id="count-708">1</span>
                                                    <span>votes</span>
                                                </div>
                                                <div class="downvote">
                                                    <i class="fa-2x fas fa-caret-down" onclick="vote(708,'down')"></i>
                                                </div>
                                            ...
                                            <div class="question-answers p-2">
                                                <div class="questions d-flex mb-4">
                                                    ...
                                                    <strong class="userQuestion hide-class"> How to apply </strong>
                                                </div>
                                                <div class="answer d-flex">
                                                    ...
                                                    <div class="d-flex flex-column flex-shrink-1">
                                                        ...
                                                        <strong class="reply">On the page, there is an "apply" button. You can apply by clicking on it and creating an online portal through China Admissions.&nbsp;<div></div></strong>
                                                        <span class="author">by Saskia - China Admissions on August 22, 2022</span>
                                        ...
                                        <li class="d-flex mt-3 mb-3">
                                            <div class="votes d-flex flex-column align-items-center flex-shrink-0" style="border-right: 1px solid #ddd;text-align: center;color: #000;padding: 0;margin: 0;width: 65px;">
                                                <div class="upvote">
                                                    <i class="fa-2x fas fa-caret-up" onclick="vote(1412,'up')"></i>
                                                </div>
                                                <div class="align-items-center d-flex flex-column vote-count">
                                                    <span class="count" id="count-1412">1</span>
                                                    <span>votes</span>
                                                </div>
                                                <div class="downvote">
                                                    <i class="fa-2x fas fa-caret-down" onclick="vote(1412,'down')"></i>
                                                </div>
                                            ...
                                            <div class="question-answers p-2">
                                                <div class="questions d-flex mb-4">
                                                    <span class="d-md-block d-none" style="min-width:100px"><strong>Question:</strong> </span>
                                                    <span class="d-md-none d-block"><strong>Q:</strong> </span>
                                                    <strong class="userQuestion hide-class"> do I need the English test if I'm from a native English speaking country</strong>
                                                </div>
                                                <div class="answer d-flex">
                                                    <span class="d-md-block d-none" style="min-width:100px"><strong>Answer:</strong> </span>
                                                    <span class="d-md-none d-block"><strong>A:</strong> </span>
                                                    <div class="d-flex flex-column flex-shrink-1">
                                                        ...
                                                        <strong class="reply">If you come from the following countries you do not need an English Certificate: UK, USA, Ireland, Canada, Australia, New Zealand, South Africa.<div><br></div>
                                                            <div>If you are from a different country you can provide a letter from your school stating your education was taught in English.</div>
                                                        </strong>
                                                        <span class="author">by Saskia - China Admissions on March 23, 2023</span>
                                        ...
                                        <li class="d-flex mt-3 mb-3">
                                            <div class="votes d-flex flex-column align-items-center flex-shrink-0" style="border-right: 1px solid #ddd;text-align: center;color: #000;padding: 0;margin: 0;width: 65px;">
                                                <div class="upvote">
                                                    <i class="fa-2x fas fa-caret-up" onclick="vote(77,'up')"></i>
                                                </div>
                                                <div class="align-items-center d-flex flex-column vote-count">
                                                    <span class="count" id="count-77">0</span>
                                                    <span>votes</span>
                                                </div>
                                                <div class="downvote">
                                                    <i class="fa-2x fas fa-caret-down" onclick="vote(77,'down')"></i>
                                                </div>
                                            ...
                                            <div class="question-answers p-2">
                                                <div class="questions d-flex mb-4">
                                                    <span class="d-md-block d-none" style="min-width:100px"><strong>Question:</strong> </span>
                                                    <span class="d-md-none d-block"><strong>Q:</strong> </span>
                                                    <strong class="userQuestion hide-class"> Is there a phd scholarship?</strong>
                                                </div>
                                                <div class="answer d-flex">
                                                    <span class="d-md-block d-none" style="min-width:100px"><strong>Answer:</strong> </span>
                                                    <span class="d-md-none d-block"><strong>A:</strong> </span>
                                                    <div class="d-flex flex-column flex-shrink-1">
                                                        ...
                                                        <strong class="reply">
                                                            <div>
                                                                <p style="color: #222222; font-family: arial, helvetica, sans-serif; font-size: small;" class="hide-class"><strong><span style="font-family: Arial; font-size: 13.3333px;">At the moment, our basic Free Service is only for students who are applying as self-funded students (no scholarship).</span></strong></p>
                                                                <p style="color: #222222; font-family: arial, helvetica, sans-serif; font-size: small;" class="hide-class"><span style="font-family: Arial; font-size: 13.3333px;">But, we can help you apply for a CSC scholarship with our&nbsp;<strong><a style="color: #1155cc;" href="https://www.china-admissions.com/china-scholarship-application-service/" target="_blank" rel="noopener" data-saferedirecturl="https://www.google.com/url?q=https://www.china-admissions.com/china-scholarship-application-service/&amp;source=gmail&amp;ust=1584030860890000&amp;usg=AFQjCNFkHY-GzqqYOtc5Dq0n088xgjb2Zw">Scholarship Consulting Service</a></strong>. </span><a href="https://www.china-admissions.com/china-scholarship-application-service/"><span style="font-family: Arial;"><span style="font-size: 13px; white-space: pre-wrap;">https://www.china-admissions.com/china-scholar</span></span><span class="coll-ellipsis"> ... </span></a><a href="#" data-ctrl=""> More</a></p>
                                                            </div>
                                                            <div><span style="color: #000000; font-family: Arial; font-size: 13px; white-space: pre-wrap;">Using our Scholarship Consulting Service, you will get help in finding the best program and scholarships, guides on how to apply and application timeline, documents review, and get your scholarship application submissions supervised by our experienced team.</span></div>
                                                        </strong>
                                                        <span class="author">by Saskia - China Admissions on February 14, 2022</span>
                ...
                <div class="row">
                    <div class="col-sm">
                        <article id="admissions-reviews" style="margin-bottom:0;">
                            <section class="mdc-card__supporting-text">
                                <h3 class="ca-card-title mt-5">📝 Beijing Foreign Studies University (BFSU) Reviews</h3>
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="city-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-769 {
                                                                    fill: url(#769_SVGID_1_);
                                                                }

                                                                .svg-hovered-769 {
                                                                    fill: url(#769_SVGID_2_);
                                                                }

                                                                .svg-active-769 {
                                                                    fill: url(#769_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="769_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="769_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="769_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-769" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-769" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-769" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-769 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-769" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-769" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-769" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-769 {
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-769" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-769" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-769" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="accommodation-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-338 {
                                                                    fill: url(#338_SVGID_1_);
                                                                }

                                                                .svg-hovered-338 {
                                                                    fill: url(#338_SVGID_2_);
                                                                }

                                                                .svg-active-338 {
                                                                    fill: url(#338_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="338_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="338_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="338_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-338" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-338" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-338" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-338 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-338" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-338" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-338" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-338 {
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-338" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-338" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-338" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="food-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-108 {
                                                                    fill: url(#108_SVGID_1_);
                                                                }

                                                                .svg-hovered-108 {
                                                                    fill: url(#108_SVGID_2_);
                                                                }

                                                                .svg-active-108 {
                                                                    fill: url(#108_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="108_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="108_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="108_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-108" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-108" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-108" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-108 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-108" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-108" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-108" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-108 {
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-108" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-108" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-108" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="facilities-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-57 {
                                                                    fill: url(#57_SVGID_1_);
                                                                }

                                                                .svg-hovered-57 {
                                                                    fill: url(#57_SVGID_2_);
                                                                }

                                                                .svg-active-57 {
                                                                    fill: url(#57_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="57_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="57_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="57_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-57" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-57" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-57" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-57 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-57" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-57" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-57" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-57 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="money-for-value-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-679 {
                                                                    fill: url(#679_SVGID_1_);
                                                                }

                                                                .svg-hovered-679 {
                                                                    fill: url(#679_SVGID_2_);
                                                                }

                                                                .svg-active-679 {
                                                                    fill: url(#679_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="679_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="679_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="679_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-679" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-679" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-679" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-679 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-679" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-679" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-679" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-679 {
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="classes-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-796 {
                                                                    fill: url(#796_SVGID_1_);
                                                                }

                                                                .svg-hovered-796 {
                                                                    fill: url(#796_SVGID_2_);
                                                                }

                                                                .svg-active-796 {
                                                                    fill: url(#796_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="796_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="796_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="796_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-796" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-796" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-796" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-796 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-796" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-796" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-796" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-796 {
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-796" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-796" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-796" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="student-experience-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-863 {
                                                                    fill: url(#863_SVGID_1_);
                                                                }

                                                                .svg-hovered-863 {
                                                                    fill: url(#863_SVGID_2_);
                                                                }

                                                                .svg-active-863 {
                                                                    fill: url(#863_SVGID_3_);
                                                                }
                                                                ...
                                                                <linearGradient id="863_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="863_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="863_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-863" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-863" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-863" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-863 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-863" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-863" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-863" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-863 {
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-863" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-863" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-863" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="star-rating-wrapper">
                                                    <div class="recommendation-stars">
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <linearGradient id="5_SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:lightgray"></stop>
                                                                    <stop offset="1" style="stop-color:lightgray"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="5_SVGID_2_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:orange"></stop>
                                                                    <stop offset="1" style="stop-color:orange"></stop>
                                                                </linearGradient>
                                                                <linearGradient id="5_SVGID_3_" gradientUnits="userSpaceOnUse" x1="0" y1="-50" x2="0" y2="250">
                                                                    <stop offset="0" style="stop-color:#FEF7CD"></stop>
                                                                    <stop offset="1" style="stop-color:#FF9511"></stop>
                                                                </linearGradient>
                                                                <polygon data-side="center" class="svg-empty-5" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-5" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-active-5" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-5 {
                                                        ...
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-5" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-active-5" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-5" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                        <div class="jq-star" style="width:14px;  height:14px;"><svg version="1.0" class="jq-star-svg" shape-rendering="geometricPrecision" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="305px" height="305px" viewBox="60 -62 309 309" style="enable-background:new 64 -59 305 305; stroke-width:4px;" xml:space="preserve">
                                                                <style type="text/css">
                                                                .svg-empty-5 {
                                                                ...
                                                                <polygon data-side="center" class="svg-empty-5" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 212.9,181.1 213.9,181 306.5,241 " style="fill: transparent; stroke: black;"></polygon>
                                                                <polygon data-side="left" class="svg-empty-5" points="281.1,129.8 364,55.7 255.5,46.8 214,-59 172.5,46.8 64,55.4 146.8,129.7 121.1,241 213.9,181.1 213.9,181 306.5,241 " style="stroke-opacity: 0;"></polygon>
                                                                <polygon data-side="right" class="svg-empty-5" points="364,55.7 255.5,46.8 214,-59 213.9,181 306.5,241 281.1,129.8 " style="stroke-opacity: 0;"></polygon>
                                                            </svg></div>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                ...
                                <div class="review-container">
                                    <div class="rating-left d-flex align-items-center mb-2">
                                        <h2 class="m-0"><span class="badge badge-warning ">5.9</span></h2>
                                    </div>
                                    <div class="review-meta d-flex font-weight-bold justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <div class="nationality mr-2 font-weight-light"><span class=" flag-icon-squared flag-icon flag-icon-in"></span>
                                                - India</div>
                                        </div>
                                    ...
                                    <div class="review-comment mt-2">
                                        <strong>"</strong>IBS BFSU may have a lot to improve in the courses and faculty aspects, but it is definitely a school that has attracted exchange students and international students from all over the world, definitely a good place to meet new people that one would hardly meet anywhere else in the world. To acquire accommodation used to be effortless but these days due to the increasing amount of students it is a challenge to stay on campus, and places near but outside campus are quite pricey. We are hoping that there will be a change for the better in the years to come. <strong>"</strong>
                                    </div>
                                ...
                                <div class="review-container">
                                    <div class="rating-left d-flex align-items-center mb-2">
                                        <h2 class="m-0"><span class="badge badge-warning ">7.6</span></h2>
                                    </div>
                                    <div class="review-meta d-flex font-weight-bold justify-content-between">
                                        <div class="d-flex">
                                            <div class="student-name mr-4 ">
                                            ...
                                            <div class="nationality mr-2 font-weight-light"><span class=" flag-icon-squared flag-icon flag-icon-ua"></span>
                                                - Ukraine</div>
                                        </div>
                                        <div class="review-date mr-2 font-weight-light">
                                            Reviewed on: 2019-11-23
                                    ...
                                    <div class="review-comment mt-2">
                                        <strong>"</strong>I have studied in BFSU (Beiwai) for 2 years and those definitely were great years of my life. Beiwai has amazing campus, probably the cozies in Beijing. It's not too big, and there are places where students can meet and talk, pond in front of the library is awesome, for example. The building of the library itself is very good as well, many students often go there to study. I can't say that classes that I took in Beiwai were this great, but because there were many foreign students (new exchange students every semester), studying was fun and I definitely expanded my network of friends. I'd recommend Beiwai to those who want to experience life in China and, at the same time, live in international community. <strong>"</strong>
                                    </div>
                                    <small class="review-ratings d-flex flex-column mt-2">
                                        <div class="emoji-rate-location mr-4">Self funded</div>
                                        <div class="emoji-rate-accommodation mr-4">Lived on campus </div>
                                ...
                                <div class="review-container">
                                    ...
                                    <div class="review-meta d-flex font-weight-bold justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <div class="nationality mr-2 font-weight-light"><span class=" flag-icon-squared flag-icon flag-icon-de"></span>
                                                - Germany</div>
                                        </div>
                                        <div class="review-date mr-2 font-weight-light">
                                            Reviewed on: 2019-11-23
                                    ...
                                    <div class="review-comment mt-2">
                                        <strong>"</strong>BFSU IBS is a very international business school with students from all over the world. I really liked that all courses are offered in English and all students speak English. The atmosphere on campus is amazing and people are very open to all kinds of nationalities. Although I’m not happy about the quality of the lectures. Often, the content was simply not up-to-date. In addition, there are no opportunities given to get in contact with companies in China. Nevertheless, I appreciated the Chinese language courses which were offered to students. Another positive factor is the variety of Chinese culture related courses that are offered at IBS. To sum up, it is a great place to have a fun time and learn a lot about China and its’ economy, but in terms of academic quality, I was a little disappointed. I expected to learn more and be surrounded by people who want to build successful careers, instead students at IBS mostly care about partying and how to graduate with the minimum amount of effort. <strong>"</strong>
                                    </div>
                                    <small class="review-ratings d-flex flex-column mt-2">
                                        <div class="emoji-rate-location mr-4">Self funded</div>
                                        <div class="emoji-rate-accommodation mr-4">Lived on campus </div>
                                        <div class="emoji-rate-accommodation mr-4">None in
                                            Short-term/Exchange Program </div>
                                    </small>
                                </div>
                                <div class="mt-3 mb-3">
                                    <div class="divider"> </div>
                                ...
                                <div class="review-container">
                                    <div class="rating-left d-flex align-items-center mb-2">
                                        <h2 class="m-0"><span class="badge badge-warning ">4.5</span></h2>
                                    </div>
                                    <div class="review-meta d-flex font-weight-bold justify-content-between">
                                        <div class="d-flex">
                                            <div class="student-name mr-4 ">
                                            ...
                                            <div class="nationality mr-2 font-weight-light"><span class=" flag-icon-squared flag-icon flag-icon-"></span>
                                            </div>
                                        </div>
                                        <div class="review-date mr-2 font-weight-light">
                                    ...
                                    <div class="review-comment mt-2">
                                        <strong>"</strong>I have attended the Online LLM in Chinese Business and Commercial Law fron 2017 to 2019. The program is innovative and interesting, but it has one major downside: its web platform, a.k.a. the core of an Online LLM.

                                        Tha platform is (or at least was till 2019) really really difficult to use. The problem is not its "old-fashioned" style, but rather its usability, for example some lessons are recorded in a way so that they are difficult to hear regardless of the volume you set, then, you cannot stop the lesson in order to take a little break or you risk to lose all the progress and have to rewatch everything again (and You cannot know in advance what is the lenght of the lesson because some of them are split and you have to finish them in order to take a break). It is ok then, you think, you avoid every break, you think, but here is the trick: the web platform is often down and, guess what, you have to rewatch an entire lesson if it goeas down and up again (if you are lucky enough that it goes up again).
                                        If it does not go up again by itself, you have to write for IT support, this usually takes few days to solve but if they are on vacation it could take much much more.. The problem is that when you choose an Online LLM usually it is because You have also a work and so it is only natural to program study session during summer break or during Christmas holiday, and if the platform goes down (and it will go down for sure) you have to wait until the end of your vacation and the it team vacation in order to have the platform up and running. Moreover, you cannot understand when the lessons are recorded and if those are up-to-date or not, there is no textbook support (nor material or even the slides on the platform), so you have to ask via email, wait and hope.

                                        The staff at the University is, instead, friendly and supportive and helped me to live through Chinese bureaucracy. Also the Professors were really helpful and supportive (when the interaction with them wasn't filtered through the hideous web platform).

                                        I cannot recommend this program until the web platform will be properly updated.

                                        The evaluation regarding Food, Facilities and Accomodation are N.A. since it is an online LLM, I gave an 8/10 since it is mandatory to evaluate them in order to submit a review. <strong>"</strong>
                                    </div>
                                    <small class="review-ratings d-flex flex-column mt-2">
                                        <div class="emoji-rate-location mr-4">Self funded</div>
                                        <div class="emoji-rate-accommodation mr-4">Lived off campus </div>
                                        <div class="emoji-rate-accommodation mr-4">None in
                                            Online Certificate in Chinese Business and Commercial Law </div>
                                    </small>
                                </div>
                                <div class="mt-3 mb-3">
                                    <div class="divider"> </div>
                                ...
                                <div class="review-container">
                                    <div class="rating-left d-flex align-items-center mb-2">
                                        <h2 class="m-0"><span class="badge badge-warning ">5.4</span></h2>
                                    </div>
                                    <div class="review-meta d-flex font-weight-bold justify-content-between">
                                        <div class="d-flex">
                                            <div class="student-name mr-4 ">
                                            ...
                                            <div class="nationality mr-2 font-weight-light"><span class=" flag-icon-squared flag-icon flag-icon-my"></span>
                                                - Malaysia</div>
                                        </div>
                                        <div class="review-date mr-2 font-weight-light">
                                    ...
                                    <div class="review-comment mt-2">
                                        <strong>"</strong>It was totally new experience for me. The environment and facilities were good. The food was a major problem for me but i got used to it after 2 months in China. China is a beautiful place and has long history. Overall studying in beijing china was really meaningful for me. <strong>"</strong>
                                    </div>
                                    <small class="review-ratings d-flex flex-column mt-2">
                    ...
                    <section class="mdc-card__supporting-text p-0 p-md-3">
                        ...
                        <section class="d-lg-flex ">
                            ...
                            <div class="col-md-4 col-12 p-0">
                                <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0">
                                    <div class="card-body d-flex pl-2 pr-2 pb-2">
                                        <div class="p-0 col-lg-3"> <img style="width:60px;height:60px;background:#fff;padding:5px;" alt="Beijing Bailie University (BJBU) Logo" nitro-lazy-src="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/school_logos/Beijing_Bailie_University_(BJBU).png" class="nitro-lazy" decoding="async" nitro-lazy-empty="" id="MTA1ODA6MTk3-1" src="data:image/svg+xml;nitro-empty-id=MTA1ODA6MTk3-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMTgwIDE4MCIgd2lkdGg9IjE4MCIgaGVpZ2h0PSIxODAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+"> </div>
                                        <div class="p-0 col-9">
                                            <div class="d-flex justify-content-between">
                                                <div class="justify-content-start w-100 col-7 p-0">
        ...
        <div class="col-12 pl-lg-0 pr-lg-0 wordpress-posts mb-4">
            <div class="col p-0">
                <article style="margin-bottom:0;">
                    <section class="mdc-card__supporting-text p-0 p-md-3">
                        <h3 class="ca-card-title blog-title-about">Blog Posts About Beijing Foreign Studies University (BFSU)</h3>
                        <h3 class="ca-card-title blog-title-related d-none">Related Posts</h3>
                        <section class="d-lg-flex " id="wordpress-posts">
                            <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0" style="width: 19rem; max-width: 19rem;" data-post="132406">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <img src="https://img-cdn-china-admissions.imgix.net/wp-content/uploads/2022/02/best-chinese-schools-in-beijing.png?auto=format%2Cenhance%2Ccompress&amp;w=300&amp;h=300" class="card-img-top embed-responsive-item" alt="">
                                </div>
                                <div class="card-body pl-2 pr-2 pb-2">
                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100">9 Best Schools to Study Chinese in Beijing in 2024!</h3>
                                    <div class="d-flex flex-column">
                                        <small>Savannah Billman</small>
                                        <small>October 29, 2022</small>
                                    </div>
                                    <a class="stretched-link" target="blank" href="https://www.china-admissions.com/blog/9-best-schools-to-study-chinese-in-beijing/"></a>
                                </div>
                            </div>
                            <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0" style="width: 19rem; max-width: 19rem;" data-post="219491">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <img src="https://img-cdn-china-admissions.imgix.net/wp-content/uploads/2023/07/China-Admissions-Famous-People-scaled.jpg?auto=format%2Cenhance%2Ccompress&amp;w=300&amp;h=300" class="card-img-top embed-responsive-item" alt="">
                                </div>
                                <div class="card-body pl-2 pr-2 pb-2">
                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100">4 International Icons in China’s Education Landscape</h3>
                                    <div class="d-flex flex-column">
                                        <small>Kay Marlowe</small>
                                        <small>July 6, 2023</small>
                                    </div>
                                    <a class="stretched-link" target="blank" href="https://www.china-admissions.com/blog/4-international-icons-in-chinas-education-landscape/"></a>
                                </div>
                            </div>
                            <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0" style="width: 19rem; max-width: 19rem;" data-post="136010">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <img src="https://img-cdn-china-admissions.imgix.net/wp-content/uploads/2021/12/China-Studies-students.jpg?auto=format%2Cenhance%2Ccompress&amp;w=300&amp;h=300" class="card-img-top embed-responsive-item" alt="">
                                </div>
                                <div class="card-body pl-2 pr-2 pb-2">
                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100">Chinese Universities with No Service Fees for 2023</h3>
                                    <div class="d-flex flex-column">
                                        <small>Savannah Billman</small>
                                        <small>September 23, 2022</small>
                                    </div>
                                    <a class="stretched-link" target="blank" href="https://www.china-admissions.com/blog/chinese-universities-with-no-service-fees-for-2022/"></a>
                                </div>
                            </div>
                            <div class="card w-sm-auto mr-2 pb-2 mt-1 mb-1 ml-auto mr-auto mr-md-2 ml-md-0" style="width: 19rem; max-width: 19rem;" data-post="30971">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <img src="https://img-cdn-china-admissions.imgix.net/wp-content/uploads/2017/07/university-application-in-china-1.jpg?auto=format%2Cenhance%2Ccompress&amp;w=300&amp;h=300" class="card-img-top embed-responsive-item" alt="">
                                </div>
                                <div class="card-body pl-2 pr-2 pb-2">
                                    <h3 class="ca-card-title p-0 m-0 ca-card-title-three-lines w-100">FAQ: How Long Does It Take To Process My Chinese University Application in 2022?</h3>
                                    <div class="d-flex flex-column">
                                        <small>Savannah Billman</small>
                                        <small>November 29, 2021</small>
                                    </div>
                                    <a class="stretched-link" target="blank" href="https://www.china-admissions.com/blog/fastest-chinese-universities-accept-international-students/"></a>
                                </div>
                            </div>
                        </section>
    ...
    <script src="blob:https://apply.china-admissions.com/3e5d1f33-4bf4-4197-8032-ca4997faa6c9" data-nitro-for-id="2e8cb65a563e3cc5eb991ab427dd437e-1" id="2e8cb65a563e3cc5eb991ab427dd437e-1"></script>
</div>
