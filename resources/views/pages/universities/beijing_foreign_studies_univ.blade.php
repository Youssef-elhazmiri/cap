...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Beijing Foreign Studies University (BFSU) Logo" nitro-lazy-src="images/univ_logo/beijing_foreign_studies_univ.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI5ODoxOTc=-1" src="images/univ_logo/beijing_foreign_studies_univ.jpg"> </div>
    </div>
                            ...
                            <section class="mdc-card__supporting-text">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade  " id="nav-no-6-building" role="tabpanel" aria-labelledby="nav-no-6-building-tab">
                                        ...
                                        <div class="d-flex accomodation-images" style="overflow-x:scroll;height:200px;">
                                            <div class="video"> </div> <a href="{{ route('listA') }}" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6.jpg"> </div>
                                            </a> <a href="{{ route('listA') }}" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6 - Double Room">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Double-Room1.jpg"> </div>
                                            </a> <a href="{{ route('listA') }}" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6 - Accommodations">
                                                <div style="background:url(&quot;data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAAAICTAEAOw==&quot;);background-size:cover;background-position:center;" class="accomodation-image mt-2 mb-2 ml-2 mr-2 grid-image nitro-lazy" nitro-lazy-bg="https://cdn-eblcf.nitrocdn.com/lZuytgWjZprCqHbvUEDajTtGzfSdJiEL/assets/images/optimized/rev-4427ecb/upload-china-admissions.imgix.net/uploads/accommodation_pictures/Building-6-Accommodations.jpg"> </div>
                                            </a> <a href="{{ route('listA') }}" class="w-30" data-fancybox="no-6-building-gallery" data-caption="Building No. 6 - Amenities">
