@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Southwest Petroleum University (SWPU)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/Southwest_Petroleum_University_(SWPU)_2.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Southwest_Petroleum_University_(SWPU)_1.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Southwest_Petroleum_University_(SWPU)_4.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Southwest Petroleum University (SWPU) Logo" nitro-lazy-src="images/univ_logo/southwest-petroleum-university.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI1MToxODM=-1" src="images/univ_logo/southwest-petroleum-university.jpg"> </div>
    </div>
