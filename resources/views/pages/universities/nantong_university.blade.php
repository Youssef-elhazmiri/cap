@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Nantong University (NTU)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/Nantong_University_Campus.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Nantong-University-2.avif" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Nantong_University_Yanching.avif" style="width:100%">
        </div>
    </div>
    <br>
...
<div class="container">
    <div class="school-page-logo">
        <div class="mr-2 mr-md-4"> <img alt="Nantong University (NTU) Logo" nitro-lazy-src="images/univ_logo/nantong_university.jpg" class="logo lazyloaded" decoding="async" nitro-lazy-empty="" id="ODI1MToxNjM=-1" src="images/univ_logo/nantong_university.jpg"> </div>
    </div>
