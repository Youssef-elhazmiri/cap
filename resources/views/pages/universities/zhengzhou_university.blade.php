@extends('layouts.app')
@section('content')
@section('title') {{'CAP - Zhengzhou University (ZZU)'}} @endsection
...
<div class="slideshow-container">
        <div class="mySlides fade">
            <img src="images/univ_pic/2.jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/Zhengzhou_University.jpg" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="images/univ_pic/unnamed-5-jpg.webp" style="width:100%">
        </div>
    </div>
    <br>
